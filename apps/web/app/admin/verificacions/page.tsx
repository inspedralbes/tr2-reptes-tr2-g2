                            ...
                            <div className="flex flex-col gap-1 min-w-0">
                              <div className="text-xs font-bold text-gray-700 truncate">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {[
                                    { id: 'acord_pedagogic', name: 'Acord Pedagògic', url: ins.url_acord_pedagogic },
                                    { id: 'autoritzacio_mobilitat', name: 'Aut. Mobilitat', url: ins.url_autoritzacio_mobilitat },
                                    { id: 'drets_imatge', name: 'Drets d\'Imatge', url: ins.url_drets_imatge }
                                  ].map(doc => (
                                    <div key={doc.id} className="flex items-center">
                                      {doc.url ? (
                                        <a
                                          ...
                                          className="text-[9px] font-bold bg-[#00426B] text-white px-2 py-1 uppercase hover:bg-[#4197CB] transition-colors flex items-center gap-1"
