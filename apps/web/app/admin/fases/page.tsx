            ...
            {fases.map((fase) => (
              <div 
                ...
                className={`p-8 bg-white rounded-3xl border-2 transition-all duration-300 ${
                  fase.activa ? 'border-blue-500 shadow-xl shadow-blue-900/5' : 'border-gray-100 opacity-60 grayscale-[0.5]'
                }`}
              >
                <div className="flex flex-col md:flex-row justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                       ...
                       {fase.activa && (
                         <span className="px-3 py-1 bg-blue-600 text-white text-[10px] font-black uppercase tracking-widest rounded-full animate-pulse">ACTIVA</span>
                       )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full bg-gray-50 border-none rounded-xl text-sm font-bold text-gray-700 px-4 py-3 focus:ring-2 focus:ring-blue-500"
                        />
                      </div>
                      <div>
