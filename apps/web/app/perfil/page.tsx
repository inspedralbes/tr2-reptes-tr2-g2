          ...
          <div className="px-8 pb-10 relative">
            ...
            <div className="pt-16">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button className="px-6 py-3 bg-gray-50 text-gray-400 font-bold rounded-xl text-xs uppercase tracking-widest cursor-not-allowed">
                  Editar Perfil
                </button>
              </div>
                ...
                <div className="space-y-6">
                   <div>
                    ...
                    <button className="w-full flex items-center justify-between p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors group">
                      ...
                      <svg className="w-4 h-4 text-gray-300 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                    </button>
                  </div>
