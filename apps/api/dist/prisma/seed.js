...
async function main() {
    ...
    const passAdmin = await bcrypt_1.default.hash('Admin@1234', salt);
    const passCentro = await bcrypt_1.default.hash('Centro@1234', salt);
    const passProfe = await bcrypt_1.default.hash('Profe@1234', salt);
    // 1. ADMIN (Global)
